...
loginForm.addEventListener('submit', (e) => {
	...
	console.log(data);
	fetch(`http://16.171.196.156/api/adminlogin`, {
		method: 'POST',
		headers: {
...
const service_clinic_address = document.getElementById(
	'service_clinic_address'
);
...
const edit_service_clinic_address = document.getElementById(
	'edit_service_clinic_address'
);
// search
...
const doctorRender = (arr, list = doctorList) => {
    ...
    <div class="card_box">
    <div class="card_top">
<img class="card_top_img" src="http://16.171.196.156/${el?.image}" alt="">
    </div>
    <div class="card_body">
...
const getFunc = (post_url, renderFunc) => {
	fetch(`http://16.171.196.156/api/${post_url}`, {
		method: 'GET',
	})
		.then((res) => res.json())
		.then((data) => {
...
const getAsyncFunc = async (post_url) => {
	const res = await fetch(`http://16.171.196.156/api/${post_url}`, {
		method: 'GET',
	});
...
const editClinic = (id) => {
	fetch(`http://16.171.196.156/api/clinics/${id}`, {
		method: 'GET',
	})
		.then((res) => res.json())
		.then((data) => {
...
const deleteDoctorFunc = (id) => {
	console.log(id);
	fetch(`http://16.171.196.156/api/doctor/${id}`, {
		method: 'DELETE',
		headers: {
			Authorization: `Bearer ${token}`,
		},
...
const deleteServiceFunc = (id) => {
	console.log(id);
	fetch(`http://16.171.196.156/api/service/${id}`, {
		method: 'DELETE',
		headers: {
			Authorization: `Bearer ${token}`,
		},
...
clinic_search.addEventListener('input', (e) => {
	...
	fetch(`http://16.171.196.156/api/clinics/search/${text}`, {
		method: 'GET',
		headers: {
...
doctor_search.addEventListener('input', (e) => {
	...
	fetch(`http://16.171.196.156/api/doctors/search/${text}`, {
		method: 'GET',
		headers: {
			'Content-Type': 'appliocation/json',
		},
...
service_search.addEventListener('input', (e) => {
	...
	fetch(`http://16.171.196.156/api/service/search/${text}`, {
		method: 'GET',
		headers: {
			'Content-Type': 'appliocation/json',
		},
